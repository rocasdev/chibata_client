...
const Signuporg = () => {
  ...
  const validationSchema = Yup.object({
    ...
    contact_number: Yup.string().required('Este campo es requerido').min(10, "Debe ser mínimo 10 digitos").max(10, "Debe ser máximo 10 digitos").transform(Yup.number),
    ...
    doc_num: Yup.number().required('Este campo es requerido').min(6, "Debe ser mínimo 6 digitos").max(12, "Debe ser máximo 12 digitos"),
    phone_number: Yup.number().required('Este campo es requerido').min(10, "Debe ser mínimo 10 digitos").max(10, "Debe ser máximo 10 digitos"),
    pass: Yup.string()
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      toast.promise(
        axios.post('http://localhost:4000/api/auth/registerorg', values),
        {
          loading: "Registrando...",
                ...
                <Form>
                  ...
                  <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                    <div className="w-full lg:w-1/2">
                      ...
                      />
                      <ErrorMessage name="org_name" component="div" className="text-red-500 text-sm" />
                    </div>
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <Field
                        ...
                        className={`w-full border-b border-stroke bg-transparent pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white`}
                      />
                      <ErrorMessage name="nit" component="div" className="text-red-500 text-sm" />
                    </div>
                  </div>

                  <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                    <div className="w-full lg:w-1/2">
                      <Label htmlFor="address">Dirección de la Organización</Label>
                      <Field
                        as={Input}
                        id="address"
                        name="address"
                    ...
                    <div className="w-full lg:w-1/2">
                      <Label htmlFor="registration_date">Fecha de Creación</Label>
                      <Field
                        as={Input}
                        ...
                        className={`w-full border-b border-stroke bg-transparent pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white`}
                      />
                      <ErrorMessage name="registration_date" component="div" className="text-red-500 text-sm" />
                    </div>
                  </div>

                  <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                    <div className="w-full lg:w-1/2">
                      <Label htmlFor="contact_number">Telefono Organización</Label>
                      <Field
                        as={Input}
                        id="contact_number"
                        name="contact_number"
                  ...
                  <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                    <div className="w-full lg:w-1/2">
                      ...
                      <Field
                        as="select"
                        id="doc_type" name="doc_type" className={`w-full border-b border-stroke bg-transparent pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-neutral-400`}>
                        <option value="" className="text-neutral-400">Seleccionar</option>
                        <option value="CC" className="text-neutral-800">Cédula de Ciudadanía</option>
                        <option value="CE" className="text-neutral-800">Céduña de Extranjería</option>
                        <option value="PA" className="text-neutral-800">Pasaporte</option>
                      </Field>
                  ...
                  <div className="mb-7.5 flex flex-col gap-2 lg:mb-12.5 justify-center lg:gap-4 w-full items-center">
                    <Label htmlFor="imgInpSignUp" className="text-md text-neutral-400">Foto de Perfil</Label>
                  ...
                  <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                    <div className="flex flex-wrap gap-4 md:gap-10">
                      <Link href="/auth/signup" className="hover:text-green-700">
