          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Únete hoy a Chibatá e impulsa las ecoacciones locales.
              </h2>
              <p>
                ¿Qué esperas? Esta es la oportunidad que las organizaciones y fundaciones necesitaban para fomentar sus actividades ecologicas, registrate ahora y comienza a ser parte del cambio de Bogotá
              </p>
            </motion.div>
            <motion.div
              variants={{
